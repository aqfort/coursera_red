...
{
public:
    static const size_t N = static_cast<size_t>(TAirport::Last_);
    ...
    void Insert(TAirport airport) { data[static_cast<size_t>(airport)]++; }

    // удалить одно вхождение данного элемента
    void EraseOne(TAirport airport) { data[static_cast<size_t>(airport)]--; }

    // удалить все вхождения данного элемента
    void EraseAll(TAirport airport) { data[static_cast<size_t>(airport)] = 0; }
